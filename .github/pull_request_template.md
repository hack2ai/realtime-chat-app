...
- [ ] No secrets, credentials, private keys, or generated runtime data were added.
...
- [ ] I confirmed passwords, session tokens, database credentials, and private file contents are not written to logs.
